...
class ArrayType(Enum):
    """This class stores metadata about array types, such as numbers of probes of each type, and how to guess the
    array from probes in idat files."""
    ...
    def from_probe_count(cls, probe_count):
        ...
        if 56000 <= probe_count <= 1100000:
            LOGGER.warning(
                f'Probe count ({probe_count}) falls outside of normal range. Setting to newest array type: EPIC V2')
            return cls.ILLUMINA_EPIC_V2
